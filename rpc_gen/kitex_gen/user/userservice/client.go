...
type Client interface {
	...
	GetUserLogoutTime(ctx context.Context, Req *user.LogoutTimeReq, callOptions ...callopt.Option) (r *user.LogoutTimeResp, err error)
}
...
func (p *kUserServiceClient) GetUserLogoutTime(ctx context.Context, Req *user.LogoutTimeReq, callOptions ...callopt.Option) (r *user.LogoutTimeResp, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
	return p.kClient.GetUserLogoutTime(ctx, Req)
}
